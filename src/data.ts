import type { Account, Asset, DividendEvent, Transaction } from './types'
  ...
  const assets: Asset[] = [
    {
      ...
      finnhubSymbol: 'CW8.PA', createdAt: now,
    },
    {
      ...
      finnhubSymbol: 'AAPL', createdAt: now,
    },
    {
      ...
      finnhubSymbol: 'MC.PA', createdAt: now,
    },
  ]
